...
{
    public class CyrusDataContext : IdentityDbContext<ApplicationIdentityUser, ApplicationIdentityRole, int, ApplicationIdentityUserLogin, ApplicationIdentityUserRole, ApplicationIdentityUserClaim>, IEntitiesContext
    {
        ...
        public CyrusDataContext()
        {
                    
        }

        public CyrusDataContext(string nameOrConnectionString, ILogger logger)
