...
namespace Cyrus.WebApi.Controllers
{
    ...
    public class AccountController : ApiController
    {
       ...
       public ISecureTokenFormatter AccessTokenFormat { get; private set; }
        ...
        public async Task<IHttpActionResult> ChangePassword(ChangePasswordBindingModel model)
        {
            ...
            var result = await _userManager.ChangePasswordAsync(User.Identity.GetUserId<int>(), model.OldPassword,
                model.NewPassword);
        ...
        public async Task<IHttpActionResult> AddExternalLogin(AddExternalLoginBindingModel model)
        {
            ...
            //ApplicationAuthenticationTicket ticket = AccessTokenFormat.Unprotect(model.ExternalAccessToken);
            ...
            //    new ApplicationUserLoginInfo(externalData.LoginProvider, externalData.ProviderKey));
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            //    _userManager.SignIn(properties, oAuthIdentity, cookieIdentity);
            //}
            //else
            //{
        ...
        public async Task<IHttpActionResult> RegisterExternal(RegisterExternalBindingModel model)
        {
            ...
            ApplicationIdentityResult result = await _userManager.CreateAsync(user);
            if (!result.Succeeded)
            {
                return GetErrorResult(result);
            }
